...
const findMovieIntentHander = {
  canHandle(handlerInput) {
    return handlerInput.requestEnvelope.request.type = 'IntentRequest' && handlerInput.requestEnvelope.request.intent.name === 'FindMovieIntent';
  },
  handle(handlerInput) {
    const speechText = 'Finding movie intent';
